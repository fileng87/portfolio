...
export function PersonalInfoCards({ cardClassName }: PersonalInfoCardProps) {
  return (
    ...
    >
        ...
        <Card className={cn(cardClassName, 'h-full')}>
          ...
          <CardContent className="flex flex-1 flex-col p-4 pt-0">
            <div className="relative aspect-square w-full">
              <div className="absolute inset-0 flex items-center justify-center rounded-lg bg-pink-100/50 transition-opacity duration-200 dark:bg-cyan-950/50">
                <Avatar
      ...
      {/* Personal Info Card */}
      <div className="transition-all duration-300 ease-out md:col-span-9 lg:col-span-10">
        <Card className={cn(cardClassName, 'h-full')}>
          <CardHeader>
